...
conda activate /oak/stanford/groups/jamesz/wukevin/projects/mhc/RoseTTAFold/env
############################################################
# 1. generate MSAs
############################################################
...
conda deactivate
conda activate /oak/stanford/groups/jamesz/wukevin/projects/mhc/RoseTTAFold/folding-linux-env
